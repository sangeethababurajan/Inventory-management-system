...
class billClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#fbe0e0",fg="black",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System\n© 2024 All Rights Reserved",font=("times new roman",10),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#---------------------- all functions ------------------------------
    ...
    def generate_bill(self):
        if self.var_cname.get()=="" or self.var_contact.get()=="":
            ...
            fp=open(f'C:\\Users\\Sangeetha\\Downloads\\Inventory-Management-System-main\\Inventory-Management-System-main\\bill\\{str(self.invoice)}.txt','w')
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tBalaji Enterprises
\t Phone No. 9899459288 , Bangalore-110053
{str("="*46)}
