...
class salesClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text="Search",command=self.search,font=("times new roman",15,"bold"),bg="#90caf9",fg="white",cursor="hand2").place(x=360,y=100,width=120,height=28)
        ...
        #------------- image -----------------
        self.bill_photo=Image.open("C:\\Users\\Sangeetha\\Downloads\\Inventory-Management-System-main\\Inventory-Management-System-main\\images\\cat2.jpg")
...
#----------------------------------------------------------------------------------------------------
    def show(self):
        ...
        for i in os.listdir('C:\\Users\\Sangeetha\\Downloads\\Inventory-Management-System-main\\Inventory-Management-System-main\\bill\\'):
            if i.split('.')[-1]=='txt':
    ...
    def get_data(self,ev):
        ...
        fp=open(f'C:\\Users\\Sangeetha\\Downloads\\Inventory-Management-System-main\\Inventory-Management-System-main\\bill\\{file_name}','r')
        for i in fp:
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.blll_list:
                fp=open(f'C:\\Users\\Sangeetha\\Downloads\\Inventory-Management-System-main\\Inventory-Management-System-main\\bill\\{self.var_invoice.get()}.txt','r')
                self.bill_area.delete('1.0',END)
                for i in fp:
                    self.bill_area.insert(END,i)
                fp.close()
